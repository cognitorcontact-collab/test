package api.poja.io.endpoint.event.consumer;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("api.poja.io.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "api.poja.io.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
